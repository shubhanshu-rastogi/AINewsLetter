...
def carousel_outline(content: dict, brand: BrandVoice) -> list[dict]:
    ...
    slides = [
        ...
        {"slide": 4, "title": "Testing & Quality", "bullets": [(content.get("testing") or {}).get("title", "Quality engineering insight")]},
        {"slide": 5, "title": "Enterprise AI Adoption", "bullets": [(content.get("enterprise") or {}).get("use_case", "Enterprise insight")]},
        {"slide": 6, "title": "Research Watch", "bullets": [(content.get("research") or {}).get("paper", "Research insight")]},
        {"slide": 7, "title": "Coding Agent Benchmarks", "bullets": [(content.get("benchmark") or {}).get("title", "Benchmark insight")]},
        {"slide": 8, "title": "Trend Signals", "bullets": [t["signal"] for t in content.get("trends", [])[:3]] or ["Emerging signals"]},
        {"slide": 9, "title": "Final Takeaways", "bullets": content.get("final_takeaways", [])[:3] or ["Pilot before adoption"]},
        {"slide": 10, "title": "Read & Subscribe", "bullets": ["Full issue link in comments", "Follow for weekly AI + QE insights"]},
    ]
    return slides
