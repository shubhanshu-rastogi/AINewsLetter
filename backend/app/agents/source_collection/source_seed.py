...
SOURCES: list[dict[str, Any]] = [
    {
        "priority": 1,
        "source_name": "OpenAI Agents SDK / Agents Guide",
    ...
    {
        "priority": 3,
        "source_name": "Google Agent Development Kit",
        "source_type": ST.DOCUMENTATION,
    ...
    {
        "priority": 4,
        "source_name": "Microsoft Foundry: Observability in Generative AI",
        "source_type": ST.DOCUMENTATION,
    ...
    {
        "priority": 5,
        "source_name": "Google Cloud Gen AI Evaluation Service",
        "source_type": ST.DOCUMENTATION,
    ...
    {
        "priority": 7,
        "source_name": "Thoughtworks Technology Radar",
    ...
    {
        "priority": 8,
        "source_name": "Ministry of Testing Insights",
        "source_type": ST.BLOG,
        "source_url": "https://www.ministryoftesting.com/insights",
        "rss_url": None,
    ...
    {
        "priority": 10,
        "source_name": "arXiv Software Engineering Recent Papers",
        "source_type": ST.RESEARCH,
        "source_url": "https://arxiv.org/list/cs.SE/recent",
        "rss_url": None,
    ...
    },
    {
        ...
        "source_type": ST.NEWSLETTER,
        "source_url": "https://www.bensbites.com/",
        "rss_url": None,
...
async def seed_sources(session: AsyncSession) -> int:
    ...
    created = 0
    for spec in SOURCES:
        exists = await session.scalar(select(ContentSource).where(ContentSource.source_url == spec["source_url"]))
